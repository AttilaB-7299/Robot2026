...
public class SwerveModule implements CheckableSubsystem {
  ...
  public SwerveModule(int drivingCANId, int turningCANId, int encoderChannel, double chassisAngularOffset) {
    ...
    turningConfig
      ...
      .encoder.positionConversionFactor(ModuleConstants.TURNING_MOTOR_REDUCTION); //what the FUCK is ts
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    driveMotor.set(Utils.normalize(correctedDesiredState.speedMetersPerSecond / DriveConstants.MAX_SPEED_METERS_PER_SECOND));
