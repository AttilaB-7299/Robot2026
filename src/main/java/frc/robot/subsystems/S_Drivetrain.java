...
public class S_Drivetrain implements CheckableSubsystem {
   ...
   * <li> False, if the heading is not within the tolerance.
   */
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    double rotDelivered = DriveConstants.ROTATION_SPEED_SCALE * rot * DriveConstants.MAX_ANGULAR_SPEED_RADIANS_PER_SECOND;

    rotDelivered = rotDelivered * (DriveConstants.GYRO_REVERSED ? -1 : 1);
  ...
  public double getTurnRate() {
    return m_gyro.getAngularVelocityZWorld().getValueAsDouble() * (DriveConstants.GYRO_REVERSED ? -1.0 : 1.0);
  }
